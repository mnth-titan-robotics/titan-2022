...
public class DriveSystems {
    ...
    public DriveSystems(){
        ...
        this.Motor_FLD.setInverted(RobotConstants.MOTOR_INVERT_R);
        this.Motor_BLD.setInverted(RobotConstants.MOTOR_INVERT_R);
        this.Motor_FRD.setInverted(RobotConstants.MOTOR_INVERT_L);
        this.Motor_BRD.setInverted(RobotConstants.MOTOR_INVERT_L);
    }
